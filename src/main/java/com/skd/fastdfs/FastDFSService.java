/**  
 * @Title: FastDFSService.java
 * @Package com.skd.fastdfs
 * @Description: TODO
 * @author zhaoqian
 * @date 2018年5月4日
 */
...
public class FastDFSService {
    ...
    Logger logger = LoggerFactory.getLogger(FastDFSService.class);
    ...
    /**
     * 
     * ClassName: ConfigAndConnectionServer 
     * @Description: TODO
     * @author zhaoqian
     * @date 2018年5月4日
     */
    private static class ConfigAndConnectionServer {
        ...
        public ConfigAndConnectionServer invoke(int flag) throws IOException, MyException {
             ...
             * 2.配置文件的初始化信息
             */
            ClientGlobal.init(cpr.getClassLoader().getResource("fastdfs/fdfs_client.conf").getPath());
