...
public class DateUtil {
	...
	private static final String DATE_TWO = "yyyyMMdd";

	/**
	 * 
	 * @Description: 获取指定前几个月的日期
	 * @param @param date 当前日期
	 * @param @param num 当前月的前几个月
	 * @author zhaoqian
	 * @date 2017年12月8日
	 */
	...
	public static String firstDay() {
		SimpleDateFormat format = new SimpleDateFormat(DATE_TWO);
		String firstday;
		Calendar cale = null;
	 ...
	 * @return
	 */
	public static String getDateByStyle(Date date) {
	 ...
	 * @return
	 */
	public static String getDateByMon(Date date) {
		DateFormat fromat = new SimpleDateFormat("yyyyMM");
		return fromat.format(date);
	}
	 ...
	 * @return
	 */
	public static String getDateByMonBefore(Date date) {
		return DateFormatUtils.format(DateUtils.addMonths(date, -1), "yyyyMM");
	}
	 ...
	 * @return
	 */
	public static Date getDateByFormat(Date date) {
		DateFormat fromat = new SimpleDateFormat("yyyy/MM/dd HH:mm");
		String rs = fromat.format(date);
		DateFormat toFromat = new SimpleDateFormat("yyyy/MM/dd HH:mm");
		try {
			return toFromat.parse(rs);
	 ...
	 * @return String 格式化好的当前日期字符串
	 */
	public static String getYesteryyyyMMdd() {
		final SimpleDateFormat sdfShort = new SimpleDateFormat("yyyyMMdd");
		return sdfShort.format(DateUtil.addDay(new Date(), -1));
	}
	 ...
	 * @return String 格式化好的当前日期字符串
	 */
	public static String getNowyyyyMMdd(String format) {
		final SimpleDateFormat sdfShort = new SimpleDateFormat(format);
		return sdfShort.format(new Date());
	}
	 ...
	 * @return
	 */
	public static String _addDays(Date d, int mount) {
		SimpleDateFormat sdf = new SimpleDateFormat("M月d日");
		return sdf.format(DateUtils.addDays(d, mount));
	}
	/**
